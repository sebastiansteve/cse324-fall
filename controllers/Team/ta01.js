...
exports.strech02Get = (req, res, next) => {
...
exports.strech02Post = (req, res, next) => {
...
exports.strech03Get = (req, res, next) => {
...
exports.strech03Post = (req, res, next) => {
    console.log('Post request!');
    const body = [];
    req.on('data', (chunk) => {
        body.push(chunk);
